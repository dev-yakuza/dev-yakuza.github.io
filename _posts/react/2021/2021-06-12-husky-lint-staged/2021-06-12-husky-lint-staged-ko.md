...
그럼 다음 명령어를 사용하여 husky와 lint-staged를 사용할 React 프로젝트를 생성합니다.
...
이것으로 React 프로젝트에서 husky와 lint-staged를 사용하여 ESLint와 Prettier를 실행하는 방법에 대해서 알아보았습니다. 지금부터 husky와 lint-staged로 자동화된 ESLint와 Prettier를 사용해 보시기 바랍니다.
