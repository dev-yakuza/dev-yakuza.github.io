...
위의 코드는 HTML의 div 태그에 id와 class 속성을 설정하고 onclick 속성에 직접 자바스 크립트의 alert 코드를 사용하였습니다. 이처럼 우리는 이미 HTML의 속성이라는 개념을 사용 해 왔습니다. React에서는 이 속성 개념에 데이터를 전달한다는 개념을 추가 확장한 것입니다.
