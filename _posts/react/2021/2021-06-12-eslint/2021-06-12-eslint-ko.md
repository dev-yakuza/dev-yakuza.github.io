...
React에서 ESLint를 사용하기 위해, `create-react-app`으로 간단하게 프로젝트를 생성하겠습니다. `create-react-app`에 관해 잘 모르시는 분들은 아래의 링크를 참고하시기 바랍니다.
...
지금까지 대답한 ESLint의 설정 내용을 저장할 파일 포맷을 선택하는 옵션입니다. 저는 `JavaScript` 포맷을 선호하므로, `JavaScript`를 선택하여 진행하였습니다.
