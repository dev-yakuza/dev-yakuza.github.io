...
image: '/assets/images/category/environment/2018/ansible-laravel/background.jpg'
---
...
![laravel first page](/assets/images/category/environment/2018/ansible-laravel/laravel.jpg)

ララベル(Laravel)設定がよく出来てない時は下記のように500エラー画面が出ます。

![laravel 500 error page](/assets/images/category/environment/2018/ansible-laravel/laravel_error.jpg)
...
![phpmyadmin login](/assets/images/category/environment/2018/ansible-laravel/phpmyadmin_login.jpg)
...
![phpmyadmin change password](/assets/images/category/environment/2018/ansible-laravel/phpmyadmin_change_password.jpg)

画面の真ん中にある```Change password```を押してパスワードを変更します。

![phpmyadmin new password](/assets/images/category/environment/2018/ansible-laravel/phpmyadmin_new_password.jpg)

上部にあるメニュー中で```Database```を押してララベル(Laravel)と連結するデータベースを生成します。

![phpmyadmin new database](/assets/images/category/environment/2018/ansible-laravel/phpmyadmin_new_database.jpg)
