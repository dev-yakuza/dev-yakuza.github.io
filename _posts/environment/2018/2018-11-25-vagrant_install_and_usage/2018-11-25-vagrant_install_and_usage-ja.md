...
image: '/assets/images/category/environment/2018/vagrant-install-and-usage/background.jpg'
---
...
![virtualbox donwload page](/assets/images/category/environment/2018/vagrant-install-and-usage/virtualbox_download.jpg)

virtaulboxダウンロードやインストールするプロセスは一般的なソフトをインストールする方法と同じなのでここでは説明を省略します。

インストールを完了してvirtualboxを実行したら下記のような画面が見えます。

![virtualbox installed](/assets/images/category/environment/2018/vagrant-install-and-usage/virtualbox_installed.jpg)
...
![vagrant download site](/assets/images/category/environment/2018/vagrant-install-and-usage/vagrant_site.jpg)
...
![virtualbox with virtual machine](/assets/images/category/environment/2018/vagrant-install-and-usage/virtualbox-with-machine.jpg)
