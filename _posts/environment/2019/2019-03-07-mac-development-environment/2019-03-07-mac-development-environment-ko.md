...
image: '/assets/images/category/environment/2019/mac-development-environment/background.jpg'
---
...
아래에 명령어로 `pip`를 설치합니다.

```bash
sudo easy_install pip
```

파이썬(python) 가상환경(Virtual Environment) 관리를 도와주는 모듈인 `virtualenv`을 아래에 명령어로 설치합니다.
...
source /Users/jeonghean_kim/google-cloud-sdk/path.zsh.inc

# The next line enables zsh completion for gcloud.
source /Users/jeonghean_kim/google-cloud-sdk/completion.zsh.inc
