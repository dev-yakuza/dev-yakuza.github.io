...
- [Homebrew와 Shell Script를 사용하여 맥(Mac) 개발 환경 구축 자동화하기]({{site.url}}/{{page.categories}}/configure-development-environment-on-mac-with-homebrew-and-shell-script/){:target="_blank"}
...
![맥(mac) 개발환경 설정 - iTerm 다운로드](/assets/images/category/environment/2019/mac-iterm-zsh/iterm-download.jpg)

다운로드 받은 `zip` 파일을 압축해제하고 설치합니다.

![맥(mac) 개발환경 설정 - iTerm full disk access 권한 요청](/assets/images/category/environment/2019/mac-iterm-zsh/iterm-full-disk-access.jpg)

위와 같이 iTerm에서 `Full Disk Access`를 요청합니다. 오른쪽 하단의 `Open System Preferences`를 선택합니다.

![맥(mac) 개발환경 설정 - iTerm full disk access 권한 설정](/assets/images/category/environment/2019/mac-iterm-zsh/iterm-full-disk-access-grant.jpg)

위와 같이 친절한 설명과 함께 `Security & Privacy`가 활성화 됩니다. 왼쪽 하단의 자물쇠 모양을 선택하고 암호를 입력하여 수정 가능한 상태를 만듭니다.

![맥(mac) 개발환경 설정 - iTerm full disk access 권한 설정 화면](/assets/images/category/environment/2019/mac-iterm-zsh/iterm-full-disk-access-grant-setting.jpg)

상단 탭에서 `Privacy`를 선택하고, 왼쪽 리스트에서 `Full Disk Accesss`를 선택합니다.

![맥(mac) 개발환경 설정 - iTerm full disk access 권한 설정 iTerm 선택](/assets/images/category/environment/2019/mac-iterm-zsh/iterm-full-disk-access-grant-setting-select-iterm.jpg)

오른쪽의 `+` 버튼을 누릅니다. `Applications`로 이동한 후, `iTerm`를 선택하고 `Open`을 선택합니다.

![맥(mac) 개발환경 설정 - iTerm 종료](/assets/images/category/environment/2019/mac-iterm-zsh/iterm-full-disk-access-grant-setting-quit.jpg)
...
![맥(mac) 개발환경 설정 - zsh 설치](/assets/images/category/environment/2019/mac-iterm-zsh/zsh-installation.jpg)
...
![맥(mac) 개발환경 설정 - zsh 설치 완료](/assets/images/category/environment/2019/mac-iterm-zsh/zsh-install-completed.jpg)
...
![맥(mac) 개발환경 설정 - iTerm zsh 설정](/assets/images/category/environment/2019/mac-iterm-zsh/zsh-install-completed.jpg)

iTerm을 실행하고 왼쪽 상단의 `iTerms2` > `Preferences...`를 선택합니다.

![맥(mac) 개발환경 설정 - iTerm zsh 디폴트 설정](/assets/images/category/environment/2019/mac-iterm-zsh/iterm-zsh-default-setting-path.jpg)
...
![맥(mac) 개발환경 설정 - zsh 테마 설정](/assets/images/category/environment/2019/mac-iterm-zsh/zsh-theme-setting.jpg)

다운로드시 하단의 `Format`을 `All Files`로 설정합니다. 파일명 확장자가 `.itermcolors`인지 확인합니다.

다시 iTerm의 Preferences를 엽니다.

![맥(mac) 개발환경 설정 - iterm에 zsh 테마 설정](/assets/images/category/environment/2019/mac-iterm-zsh/zsh-theme-import.jpg)

위와 같이 `Profiles` > `Colors`를 선택하고 오른쪽 하단의 `Color Preset...` > `import...`를 선택합니다.

위에서 다운로드한 `Solarized Dark - Patched.itermcolors` 파일을 선택합니다.

![맥(mac) 개발환경 설정 - iterm에 zsh 테마 Solarized Dark 설정](/assets/images/category/environment/2019/mac-iterm-zsh/zsh-theme-solarized-dark.jpg)
...
![맥(mac) 개발환경 설정 - iterm](/assets/images/category/environment/2019/mac-iterm-zsh/normal_iterm.jpg)
...
![맥(mac) 개발환경 설정 - iterm powerlevel9k](/assets/images/category/environment/2019/mac-iterm-zsh/powerlevel9k.jpg)
...
![맥(mac) 개발환경 설정 - iterm 다운로드 폰트](/assets/images/category/environment/2019/mac-iterm-zsh/download-font.jpg)

다운로드가 완료되면 다운로드한 폰트 파일을 선택하여 실행합니다.

![맥(mac) 개발환경 설정 - iterm 폰트 설치](/assets/images/category/environment/2019/mac-iterm-zsh/install-font.jpg)

오른쪽 하단의 `Install Font`를 눌러 폰트를 설치합니다. 설치가 완료되면, 다시 iTerm의 Preference를 열고 `Profiles` > `Text` > `Change Font`를 선택합니다.

![맥(mac) 개발환경 설정 - iterm 폰트 설치](/assets/images/category/environment/2019/mac-iterm-zsh/set-font.jpg)

위에서 다운로드한 `Meslo LG M Regular for Powerline`를 선택합니다.

![맥(mac) 개발환경 설정 - iterm 폰트 설치 확인](/assets/images/category/environment/2019/mac-iterm-zsh/check-font.jpg)
...
![맥(mac) 개발환경 설정 - iterm 사용자명 숨김](/assets/images/category/environment/2019/mac-iterm-zsh/no-user-name.jpg)
...
![맥(mac) 개발환경 설정 - vscode zsh 설정](/assets/images/category/environment/2019/mac-iterm-zsh/vscode-setting.jpg)

검색창에 `shell`을 검색하고 `Terminal > Integrated > Shell: Osx` 부분을 `/bin/bash`에서 `/bin/zsh`로 교체합니다.

![맥(mac) 개발환경 설정 - vscode zsh shell설정](/assets/images/category/environment/2019/mac-iterm-zsh/vscode-shell-setting.jpg)
...
![맥(mac) 개발환경 설정 - vscode zsh font 설정](/assets/images/category/environment/2019/mac-iterm-zsh/vscode-zsh-font-setting.jpg)

이제 vscode를 실행하면 아래와 같이 zsh가 실행되는 것을 확인할 수 있습니다.

![맥(mac) 개발환경 설정 - vscode zsh 설정 완료](/assets/images/category/environment/2019/mac-iterm-zsh/vscode-zsh-font.jpg)
