...
image: '/assets/images/category/environment/2019/mac-iterm-zsh/background.jpg'
---
...
- [Configure automatically development environment on Mac via Homebrew and Shell Script]({{site.url}}/{{page.categories}}/configure-development-environment-on-mac-with-homebrew-and-shell-script/){:target="_blank"}
...
![Development Environment on Mac - iTerm download](/assets/images/category/environment/2019/mac-iterm-zsh/iterm-download.jpg)

unzip `zip` file you downloaded and install it.

![Development Environment on Mac - iTerm full disk access permission](/assets/images/category/environment/2019/mac-iterm-zsh/iterm-full-disk-access.jpg)

if iTerm asks you `Full Disk Access` permission, click `Open System Preferences` on the right bottom.

![Development Environment on Mac - iTerm full disk access permission setting](/assets/images/category/environment/2019/mac-iterm-zsh/iterm-full-disk-access-grant.jpg)
...
![Development Environment on Mac - iTerm full disk access permission setting screen](/assets/images/category/environment/2019/mac-iterm-zsh/iterm-full-disk-access-grant-setting.jpg)

select `Privacy` on the top tab, and click `Full Disk Accesss` on the left list.

![Development Environment on Mac - iTerm full disk access permission setting iTerm select](/assets/images/category/environment/2019/mac-iterm-zsh/iterm-full-disk-access-grant-setting-select-iterm.jpg)

click `+` button on the right side. go to `Applications`, and select `iTerm` and click `Open`.

![Development Environment on Mac - iTerm quit](/assets/images/category/environment/2019/mac-iterm-zsh/iterm-full-disk-access-grant-setting-quit.jpg)
...
![Development Environment on Mac - zsh installation](/assets/images/category/environment/2019/mac-iterm-zsh/zsh-installation.jpg)
...
![Development Environment on Mac - zsh install completed](/assets/images/category/environment/2019/mac-iterm-zsh/zsh-install-completed.jpg)

## Configure zsh to iTerm Default Terminal
iTerm's default is to use the basic shell. let's set iTerm uses basically zsh.

![Development Environment on Mac - iTerm zsh configuration](/assets/images/category/environment/2019/mac-iterm-zsh/zsh-install-completed.jpg)

execute iTerm and click `iTerms2` > `Preferences...` on the left top.

![Development Environment on Mac - iTerm zsh default setting](/assets/images/category/environment/2019/mac-iterm-zsh/iterm-zsh-default-setting-path.jpg)
...
![Development Environment on Mac - zsh theme setting](/assets/images/category/environment/2019/mac-iterm-zsh/zsh-theme-setting.jpg)
...
![Development Environment on Mac - zsh theme setting on iterm](/assets/images/category/environment/2019/mac-iterm-zsh/zsh-theme-import.jpg)
...
![Development Environment on Mac - zsh theme Solarized Dark setting on iterm](/assets/images/category/environment/2019/mac-iterm-zsh/zsh-theme-solarized-dark.jpg)
...
![Development Environment on Mac - iterm](/assets/images/category/environment/2019/mac-iterm-zsh/normal_iterm.jpg)
...
![Development Environment on Mac - iterm powerlevel9k](/assets/images/category/environment/2019/mac-iterm-zsh/powerlevel9k.jpg)
...
![Development Environment on Mac - iterm donwload font](/assets/images/category/environment/2019/mac-iterm-zsh/download-font.jpg)

after downloading it, click the font file to execute it.

![Development Environment on Mac - iterm font installation](/assets/images/category/environment/2019/mac-iterm-zsh/install-font.jpg)
...
![Development Environment on Mac - iterm font installation](/assets/images/category/environment/2019/mac-iterm-zsh/set-font.jpg)

select `Meslo LG M Regular for Powerline` what we downloaded above.

![Development Environment on Mac - iterm font installation check](/assets/images/category/environment/2019/mac-iterm-zsh/check-font.jpg)
...
![Development Environment on Mac - iterm hide user name](/assets/images/category/environment/2019/mac-iterm-zsh/no-user-name.jpg)
...
![Development Environment on Mac - vscode zsh configuration](/assets/images/category/environment/2019/mac-iterm-zsh/vscode-setting.jpg)

search `shell` and change `/bin/bash` to `/bin/zsh` on `Terminal > Integrated > Shell: Osx`.

![Development Environment on Mac - vscode zsh shell configuration](/assets/images/category/environment/2019/mac-iterm-zsh/vscode-shell-setting.jpg)
...
![Development Environment on Mac - vscode zsh font 설정](/assets/images/category/environment/2019/mac-iterm-zsh/vscode-zsh-font-setting.jpg)

after it, to execute Terminal on vscode, you can see zsh executed.

![Development Environment on Mac - vscode zsh configuration completed](/assets/images/category/environment/2019/mac-iterm-zsh/vscode-zsh-font.jpg)
