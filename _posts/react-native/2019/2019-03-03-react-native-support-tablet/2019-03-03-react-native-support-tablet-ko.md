...
![구글 플레이 - 안드로이드 앱 디바이스 지원 목록](/assets/images/category/react-native/react-native-support-tablet/android-support-devices.jpg)

왼쪽 메뉴에서 `Release management` > `Device catalog`를 선택하면 위와 같은 화면을 볼 수 있습니다. 만약 `동의` 화면이 나온다면 동의하면 위와 같은 화면을 볼 수 있습니다.

![구글 플레이 - 안드로이드 앱 마켓 정보 수정](/assets/images/category/react-native/react-native-support-tablet/android-market-info.jpg)
...
![xcode universal 앱 설정](/assets/images/category/react-native/react-native-support-tablet/ios-universal-configuration.jpg)
