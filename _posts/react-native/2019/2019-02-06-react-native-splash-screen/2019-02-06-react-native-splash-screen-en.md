...
1. [Link Libarary](#link-libarary)
    - [Upper 0.60](#upper-060)
    - [Under 0.59](#under-059)
        - [Fail To Link Library](#fail-to-link-library)
...
basically, RN(React Native) supports Splash screen. I've introduced how to use `react-native-make` tool to make Splash image in variety of sizes. you can see it to click the link below.

- [App icon & Splash image in React Native]({{site.url}}/{{page.categories}}/react-native-make/){:target="_blank"}
