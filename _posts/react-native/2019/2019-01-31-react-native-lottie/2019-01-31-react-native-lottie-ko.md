...
1. [설치](#설치)
    ...
    - [0.59 이하](#059-이하)
        - [라이브러리 연결](#라이브러리-연결)
1. [사용 방법](#사용-방법)
1. [애니메이션 파일에 이미지가 포함된 경우](#애니메이션-파일에-이미지가-포함된-경우)
    - [Git 저장소](#git-저장소)
1. [에러 대응](#에러-대응)
...
![lottie ios 추가 설정](/assets/images/category/react-native/2019/react-native-lottie/ios-settings.jpg)
...
![lottie ios framework 추가 설정](/assets/images/category/react-native/2019/react-native-lottie/add-lottie-framework.jpg)
...
![lottie ios 이미지 추가](/assets/images/category/react-native/2019/react-native-lottie/lottie_ios_image_add.jpg)

위와 같이 왼쪽 메뉴에서 프로젝트를 선택하고 ```Resources``` 폴더를 우클릭하여 ```Add Files to [project name]```을 선택합니다.

![lottie ios 이미지 추가 - 파일 선택](/assets/images/category/react-native/2019/react-native-lottie/lottie_ios_image_add_select_file.jpg)
...
![lottie ios 이미지 추가 - resources 그룹 추가](/assets/images/category/react-native/2019/react-native-lottie/lottie_ios_image_add_resources_group.jpg)
...
![lottie 0.60, iOS 빌드 에러 대응 warning: Could not find or use auto-linked - add new file](/assets/images/category/react-native/2019/react-native-lottie/add-new-file.jpg)

위의 그림과 같이 `File > New > File...`을 선택합니다.

![lottie 0.60, iOS 빌드 에러 대응 warning: Could not find or use auto-linked - add Swift file](/assets/images/category/react-native/2019/react-native-lottie/add-swift-file.jpg)

위에 그림과 같이 `Swift File`을 선택하고 오른쪽 하단의 `Next` 버튼을 선택합니다.

![lottie 0.60, iOS 빌드 에러 대응 warning: Could not find or use auto-linked - create new file](/assets/images/category/react-native/2019/react-native-lottie/create-new-file.jpg)

위와 같이 새 파일을 생성하는 화면이 나오면 오른쪽 하단의 `Create` 버튼을 선택합니다.

![lottie 0.60, iOS 빌드 에러 대응 warning: Could not find or use auto-linked - Create Bridging Header](/assets/images/category/react-native/2019/react-native-lottie/create-bridging-header.jpg)

위와 같은 화면이 나오면 오른쪽 하단의 `Create Bridging Header`를 선택합니다.
...
마지막으로 아래와 같이 `Product > Clean Build Folder`를 선택합니다.

![lottie 0.60, iOS 빌드 에러 대응 warning: Could not find or use auto-linked - Clean Build Folder](/assets/images/category/react-native/2019/react-native-lottie/clean-build-folder.jpg)
...
![lottie 빌드 에러 대응](/assets/images/category/react-native/2019/react-native-lottie/lottie_fix_error.jpg)

xcode가 실행되면 위와 같이 ```File > Workspace Settings...```를 선택합니다.

![lottie 빌드 에러 대응: 빌드 시스템 변경](/assets/images/category/react-native/2019/react-native-lottie/change_build_system.jpg)
