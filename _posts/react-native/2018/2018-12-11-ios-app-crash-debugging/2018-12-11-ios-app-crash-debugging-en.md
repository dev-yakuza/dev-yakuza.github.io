...
![app review reject](/assets/images/category/react-native/ios-app-crash-debugging/app_reject.jpg)
...
![Activity tab in Appstore Connect](/assets/images/category/react-native/ios-app-crash-debugging/appstoreconnect_activity.jpg)

click ```All Builds``` menu on left side and select build version which you submitted for app review.

![download symbol file](/assets/images/category/react-native/ios-app-crash-debugging/appstoreconnect_download_symbol.jpg)
