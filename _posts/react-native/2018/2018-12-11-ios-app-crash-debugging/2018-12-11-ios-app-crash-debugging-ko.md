...
![앱 심사 거절](/assets/images/category/react-native/ios-app-crash-debugging/app_reject.jpg)
...
![앱스토어 커넥트 Activity 탭](/assets/images/category/react-native/ios-app-crash-debugging/appstoreconnect_activity.jpg)

왼쪽에 ```All Builds```를 선택하고 앱 심사에 제출한 빌드의 버전을 선택합니다.

![심볼 파일 다운로드](/assets/images/category/react-native/ios-app-crash-debugging/appstoreconnect_download_symbol.jpg)
