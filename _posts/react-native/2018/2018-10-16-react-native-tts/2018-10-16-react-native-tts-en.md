...
- [outline](#outline)
- [react-native-tts library installaction](#react-native-tts-library-installaction)
- [how to use](#how-to-use)
- [text-to-speech](#text-to-speech)
- [configure default voice](#configure-default-voice)
  - [iOS supported voices](#ios-supported-voices)
- [reference](#reference)
