...
- [概要](#概要)
- [react-native-ttsライブラリインストール](#react-native-ttsライブラリインストール)
- [使い方](#使い方)
...
[react-native-tts](https://github.com/ak1394/react-native-tts){:rel="nofollow noreferrer" target="_blank" }を使ってリアクトネイティブ(React Native)プロジェクトでtext-to-speech機能を作って見ます。
...
インストールが終わったら下記のコマンドでreact-native-ttsライブラリとリアクトネイティブ(React Native)プロジェクトをリンクします。
