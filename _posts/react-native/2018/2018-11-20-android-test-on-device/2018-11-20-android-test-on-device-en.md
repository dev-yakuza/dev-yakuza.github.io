...
1. [outline](#outline)
1. [prepare](#prepare)
1. [Android Device test](#android-device-test)
1. [configure Android device](#configure-android-device)
1. [connect Android device](#connect-android-device)
1. [execute on Android device](#execute-on-android-device)
1. [Android version lower than 5.0](#android-version-lower-than-50)
1. [compeleted](#compeleted)
