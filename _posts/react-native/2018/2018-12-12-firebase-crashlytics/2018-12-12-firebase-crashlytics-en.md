...
- Firebase Console: [https://console.firebase.google.com/](https://console.firebase.google.com/){:rel="nofollow noreferrer noopener" target="_blank"}

select `Crasylytics` on the left menu.

![Firbase Console Crashlytics menu](/assets/images/category/react-native/firebase-crashlytics/menu-crashlytics.jpg)

when you see the screen like above, select `Set up Crashlytics`.

![Firbase Console Crashlytics step 1](/assets/images/category/react-native/firebase-crashlytics/crashlytics-step-1.jpg)

select `No, this app does not have any version of the Crashlytics SDK installed` and `Next` on the screen like above.

![Firbase Console Crashlytics step 2](/assets/images/category/react-native/firebase-crashlytics/crashlytics-step-2.jpg)
...
![Firbase Console Crashlytics step 3](/assets/images/category/react-native/firebase-crashlytics/crashlytics-step-3.jpg)
...
![Firbase Console Crashlytics dashboard](/assets/images/category/react-native/firebase-crashlytics/crashlytics-dashboard.jpg)
...
![execute xcode](/assets/images/category/react-native/firebase-crashlytics/execute_xcode.jpg)
