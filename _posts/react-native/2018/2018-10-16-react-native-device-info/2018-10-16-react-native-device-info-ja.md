...
- [概要](#概要)
- [react-native-device-infoライブラリインストール](#react-native-device-infoライブラリインストール)
- [使い方](#使い方)
...
ユーザーのデバイス情報を取得するためリアクトネイティブ(React Native)プロジェクトへ[react-native-device-info](https://github.com/rebeccahughes/react-native-device-info){:rel="nofollow noreferrer" target="_blank" }ライブラリを使ってみmしょう。
