...
- [概要](#概要)
- [flake8のインストール](#flake8のインストール)
- [flake8の使う方法](#flake8の使う方法)
- [flake8の設定](#flake8の設定)
- [完了](#完了)
...
私はDjangoプロジェクトフォルダに`virtualenv`を生成して使っています。それで、flake8が不要に`virtualenv`のフォルダまで分析をしてます。私はflake8がvirtualenvのフォルダを分析しないように設定する必要がありました。
