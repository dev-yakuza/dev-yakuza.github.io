...
image: '/assets/images/category/ildangongbu/background.jpg'
---
...
- 「일단공부(Il-Dan-Gong-Bu)」 introduce web page: [「일단공부(Il-Dan-Gong-Bu)」]( https://dev-yakuza.posstree.com/app/ildangongbu/){:target="_blank"}

you can download the app via the links below.

<div class="download_link_container">
    <a class="download_link_ios" href="https://apps.apple.com/app/ildangongbu/id1456091125" target="_blank">
...
![JLPT Japanese words app, 「일단공부(Il-Dan-Gong-Bu)」 ](/assets/images/category/ildangongbu/background.jpg)
...
![JLPT Japanese words app 「일단공부(Il-Dan-Gong-Bu)」 design](/assets/images/category/ildangongbu/development-journal/ildangongbu-design.jpg)

I used `sketchapp` for the design. and I choose the best simple design in my patterns and removed some screen.

![JLPT Japanese words app 「일단공부(Il-Dan-Gong-Bu)」 final design](/assets/images/category/ildangongbu/development-journal/ildangongbu-final-design.jpg)
