...
- 일단공부(イルタンコンブ)の紹介ページ: [일단공부(イルタンコンブ)]( https://dev-yakuza.posstree.com/app/ildangongbu/){:target="_blank"}
...
![JLPT日本語単語アプリ、 일단공부(イルタンコンブ)](/assets/images/category/ildangongbu/background.jpg)
...
![JLPT日本語単語アプリ、일단공부(イルタンコンブ)のデザイン](/assets/images/category/ildangongbu/development-journal/ildangongbu-design.jpg)

デザインは`sketchapp`で作成しました。色んなデザインパータン中で一番シンプルのデザインを選択しました。また、要らない画面も無くして最終デザインは下記のようにしました。

![JLPT日本語単語アプリ、일단공부(イルタンコンブ)のデザイン](/assets/images/category/ildangongbu/development-journal/ildangongbu-final-design.jpg)
