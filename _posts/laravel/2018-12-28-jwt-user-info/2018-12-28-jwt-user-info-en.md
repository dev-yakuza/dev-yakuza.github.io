...
![get user info](/assets/images/category/laravel/jwt-user-info/get_user_info.jpg)

if jwt token is expired or user who didn't login requests user information, you can get ```401``` error response.

![fail to get user info](/assets/images/category/laravel/jwt-user-info/fail_to_get_user_info.jpg)
