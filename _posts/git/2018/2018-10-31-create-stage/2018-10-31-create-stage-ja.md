...
image: '/assets/images/category/git/2018/create-stage/background.jpg'
---
...
![git status](/assets/images/category/git/2018/create-stage/git-status.jpg)
...
![git status after executing git add command](/assets/images/category/git/2018/create-stage/git-status-after-add.jpg)
...
![git commit](/assets/images/category/git/2018/create-stage/git-commit.jpg)

この画面は```vim```と言うドキュメント編集ツールが実行された画面です。ドキュメントを編集するためキーボードで```i```(insert)を押して変更履歴の内容を作成します。

![git commit with message](/assets/images/category/git/2018/create-stage/git-commit-with-message.jpg)

作成を完了したらキーボードの```esc```ボタンを押して```:wq```(write-quit)を入力して変更履歴を作成します。

![git completed commit](/assets/images/category/git/2018/create-stage/git-complete-commit.jpg)
...
![git log](/assets/images/category/git/2018/create-stage/git-log.jpg)
...
![git status no change](/assets/images/category/git/2018/create-stage/git-status-no-change.jpg)
...
![git status with modification](/assets/images/category/git/2018/create-stage/git-status-with-modification.jpg)
...
![git status after commit](/assets/images/category/git/2018/create-stage/git-status-after-commit.jpg)
...
![git log with new version](/assets/images/category/git/2018/create-stage/git-log-with-new-version.jpg)
