...
{% include_cached jekyll/configuration_multi_languages.md %}
...
- You can see multi-languages folders in ```_site``` folder after executing jekyll test server or building the site.
    - Execute jekyll test server: {% include_cached jekyll/test_server_command.md %}
    - Build jekyll site: {% include_cached jekyll/build_command.md %}
