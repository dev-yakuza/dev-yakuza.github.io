...
- [変数](#変数)
  ...
  - [site変数](#site変数)
  - [page変数](#page変数)
- [jekyll基本設定](#jekyll基本設定)
  - [基本設定ファイル内容](#基本設定ファイル内容)
    - [基本設定](#基本設定)
    - [プラグイン用設定](#プラグイン用設定)
      - [Paginationプラグインの設定](#paginationプラグインの設定)
      - [多言語プラグイン設定](#多言語プラグイン設定)
  - [ページ設定ファイル内容](#ページ設定ファイル内容)
    - [プラグイン設定](#プラグイン設定)
- [参考サイト](#参考サイト)
...
- paginate_path: [Paginationプラグイン]({{site.url}}/{{page.categories}}/pagination-plugin/){:target="_blank"}へ必要な設定。PaginationのURLを決定する。
