...
- [변수](#변수)
  ...
  - [site 변수](#site-변수)
  - [page 변수](#page-변수)
- [jekyll 기본 설정](#jekyll-기본-설정)
  - [기본 설정 파일 내용](#기본-설정-파일-내용)
    - [기본 설정](#기본-설정)
    - [플러그인용 설정](#플러그인용-설정)
      - [Pagination 플러그인 설정](#pagination-플러그인-설정)
      - [다국어 플러그인 설정](#다국어-플러그인-설정)
  - [페이지 설정 파일 내용](#페이지-설정-파일-내용)
    - [플러그인 설정](#플러그인-설정)
- [참고 사이트](#참고-사이트)
...
_config.yml에 원하는 변수를 선언하여 ```site.변수명```으로 해당 변수를 사용할 수 있습니다. 상단히 많은 플로그인들이 ```_config.yml```에 플러그인에 필요한 변수들을 설정하여 사용하고 있습니다.
...
- [Pagination 플러그인]({{site.url}}/{{page.categories}}/pagination-plugin/){:target="_blank"}을 참고하세요.
...
- paginate_path: [Pagination 플러그인]({{site.url}}/{{page.categories}}/pagination-plugin/){:target="_blank"}에 필요한 설정. Pagination의 URL을 결정한다.
