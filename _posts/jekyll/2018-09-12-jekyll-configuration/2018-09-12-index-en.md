...
- [jekyll basic configuration](#jekyll-basic-configuration)
  - [Default settings file](#default-settings-file)
    - [Default settings](#default-settings)
    - [Configuration for plugins](#configuration-for-plugins)
      - [Pagination plugin configuration](#pagination-plugin-configuration)
      - [Multi-languages plugin configuration](#multi-languages-plugin-configuration)
  - [Page setting options](#page-setting-options)
    - [Plugin setting options in Page settings](#plugin-setting-options-in-page-settings)
- [Reference](#reference)
...
- see [Pagination plugin]({{site.url}}/{{page.categories}}/pagination-plugin/){:target="_blank"}
...
- paginate_path: [Pagination plugin]({{site.url}}/{{page.categories}}/pagination-plugin/){:target="_blank"} option. Determine Pagination URL.
