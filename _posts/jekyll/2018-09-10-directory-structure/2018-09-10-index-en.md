...
|---|---|
| _config.xml | This is a basic setting file for configuring jekyll blog.<br>if you want to know more details, check [jekyll configuration]({{site.url}}/{{page.categories}}/configuration/){:target="_blank"}. |
