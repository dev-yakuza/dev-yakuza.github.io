...
- Kumoncho紹介ページ: [Kumoncho]( https://dev-yakuza.posstree.com/app/kumoncho/){:target="_blank"}
...
![子供向け絵本アプリKumonchoレイヤー](/assets/images/category/kumoncho/update-review/kumoncho_layer.jpg)
...
<div class="half_image_container">
    <img class="half_image" src="/assets/images/category/kumoncho/update-review/kumoncho_tutorial.jpg" alt="子供向け絵本アプリくもんちょチュートリアル">
</div>
